...
namespace PostService.Services
{
    public class ArticleService : IArticleService
    {
        ...
        private void GetFollowings(UserInfo userInfo)
        {
            ...
            string baseUrl = "https://api.trip-sharing.net/api/userservice/follow/followingids?userId=";
        ...
        private void GetUserTopics(UserInfo userInfo)
        {
            ...
            string baseUrl = "https://api.trip-sharing.net/api/userservice/user?userId=";
            // Create a request for the URL.   
            WebRequest request = WebRequest.Create(baseUrl
              + userInfo.Id);      
            // If required by the server, set the credentials.  
